...
import { ChevronLeft, ChevronRight, CircuitBoard, Maximize2, Waves, FolderOpen, Save, Minimize2, Send } from 'lucide-react';
import DrawingCanvas from '../canvas/DrawingCanvas';
import DigitalLogicCanvas from '../canvas/DigitalLogicCanvas';
import WaveformCanvas from '../canvas/WaveformCanvas';

type TabType = 'canvas' | 'digital-logic' | 'waveform';
...
const RightPanel = () => {
  ...
  const handleSubmit = () => {
    ...
    alert(`Đã submit ${activeTab === 'canvas' ? 'bản vẽ' : activeTab === 'digital-logic' ? 'mạch điện tử' : 'biểu đồ waveform'}`);
      ...
      {isPanelExpanded && (
        <div className="h-full flex flex-col">
          ...
          <div className="h-12 border-b border-border flex items-center px-2">
            <div className="grid grid-cols-3 w-full bg-gray-100 p-1 rounded-md gap-1">
              <button 
