...
const DifficultyLevels = [
  {
    id: 'beginner',
    name: 'Beginner',
    description: 'Start with basic concepts and simple problems',
    recommendedFor: 'Perfect for students new to the topic',
    questionsCount: 10,
    timeLimit: 60
  },
  {
    ...
    recommendedFor: 'For students with basic understanding',
    questionsCount: 15,
    timeLimit: 90
  },
  {
    id: 'advanced',
    name: 'Advanced',
    description: 'Master the topic with challenging exercises',
    recommendedFor: 'For students ready for complex problems',
    questionsCount: 20,
    timeLimit: 120
  }
];
...
const MathLevelChoosing: React.FC = () => {
  ...
  const handleLevelSelect = (levelId: string) => {
    navigate(`/practice/math/generating/${typeId}/${levelId}`);
  };
      ...
      >
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="flex items-center justify-between mb-8">
            <button
              onClick={() => navigate('/practice/math')}
...
export default MathLevelChoosing; 